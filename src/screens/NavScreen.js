    ...
    return (
        <header>
            <nav className="navbar">
                <div className="left">
                    <div className="logo">
                        <em className="svgIcon"><svg xmlns="http://www.w3.org/2000/svg"><use xlinkHref={process.env.PUBLIC_URL + "/svg/sprite-icons.svg#album"} /></svg></em>
                        BIBLE
                    </div>
                </div>
                ...
                <div className="right">
                    <div className="nav__icons">
                        <div className="search__icon">
                            <em className="svgIcon"><svg xmlns="http://www.w3.org/2000/svg"><use xlinkHref={process.env.PUBLIC_URL + "/svg/sprite-icons.svg#search-outline"} /></svg></em>
                        </div>
                        <div className="cog__icon">
                            <em className="svgIcon"><svg xmlns="http://www.w3.org/2000/svg"><use xlinkHref={process.env.PUBLIC_URL + "/svg/sprite-icons.svg#cog-outline"} /></svg></em>
                        </div>
                    </div>
                </div>
            </nav>
